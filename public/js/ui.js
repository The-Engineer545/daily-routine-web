        ...
        state.tasks.forEach(task => {
            ...
            taskDiv.innerHTML = `
                ...
                <div class="flex items-center gap-2">
                    <button class="edit-btn p-2 text-slate-400 hover:text-blue-500 rounded-lg hover:bg-blue-50 transition-colors" data-id="${task.id}" title="Editar tarea" aria-label="Editar tarea">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                    </button>
                    <button class="delete-btn p-2 text-slate-400 hover:text-red-500 rounded-lg hover:bg-red-50 transition-colors" data-id="${task.id}" title="Eliminar tarea" aria-label="Eliminar tarea">
